...
DataMatch AI là một hệ thống backend mạnh mẽ được xây dựng dựa trên nguyên lý **Modular Monolith** kết hợp với **Clean Architecture**. Hệ thống hỗ trợ tự động bóc tách kỹ năng từ CV (ứng viên) và JD (nhà tuyển dụng) bằng AI, đồng thời thực hiện tính toán độ tương thích (Matching Score) giữa ứng viên và công việc.
